...
//Line line;
Image wall[] = {NULL, NULL, NULL, NULL};
Image vcream;
Object npc;
...
void init() {
    ...
    //vcream = moveImage(vcream, 100, 32);
...
void update(void) {
    ...
    if(newscreen){
        ...
        if(mapposx == 3 && mapposy == 0){
            ...
            npc = createObject(NULL, 100, 100, 0, 0, 0); 
            ...
            wall[3] = createImage(img_wallhorz, 0, 0, 0, 0, 0);
            npc = createObject(img_vsurgespr, 100, 90, 1, 1, 1); 
            object[0] = createObject(img_eggpcU, 200, 100, 1, 1, 2);
            //object[1] = createObject(img_eggpcU, 150, 80, 1, 1, 0);
            // object[2] = createImage(img_eggpcU, 150, 60, 1, 1, 0);
            ...
            wall[2] = createImage(img_wallhorz, 0, 0, 0, 0, 0);
            wall[3] = createImage(img_wallhorz, 0, 0, 0, 0, 0);
            npc = createObject(img_veggspr, 100, 100, 1, 1, 0);
            object[0] = createObject(NULL, 0, 0, 0, 0, 0); 
        ...
        //Cells
            ...
            wall[3] = createImage(img_wallhorz, 0, 210, 6, 1, 0);
            npc = createObject(img_vsurgespr, 100, 90, 1, 1, 1); 
            //object[0] = createObject(img_eggpcU, 100, 100, 1, 1, 1);
